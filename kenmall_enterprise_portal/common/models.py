"""Common models file for enterprise portal."""
import uuid
...
class AbstractBase(AbstractBaseClass):
    """Baseclass for all models that are applicable to enterprises."""
...
class ToEDIAbstractBase(AbstractBase):
    """Baseclass for all models that are pushed to edi."""

    pushed_to_edi = models.BooleanField(default=False)

    def save(self, *args, **kwargs):
        """Override save."""
        super(ToEDIAbstractBase, self).save(*args, **kwargs)
